...
--**********************--
--*********SUDO ID*******--
sudo_users = {326824638} -- [[محل قرار گیری آیدی سودو ها]]
--***********************--
--********BOT OWNER******--
bot_owner = 326824638 -- [[ محل قرار گیری آیدی مدیر اصلی ربات ]]
--***********************--
-----------------------------------------------------------------------------------------------
---------------
-- Start Functions --
          ...
          if text:match("^[Ee]xpire") or text:match("^اعتبار گروه") then
            ...
            if ex == -1 then
              ...
              if b == 0 then
		        ...
		        -----------------------------------------------------------------------------------------------
        if is_momod(msg.sender_user_id_, msg.chat_id_) then
          if text:match("^[Pp]in$") or text:match("^سنجاق کن$") and msg.reply_to_message_id_ then
            local id = msg.id_
            local msgs = {[0] = id}
